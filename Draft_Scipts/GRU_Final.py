...
import time
import warnings
from Model_Class_Functions import GRUModel, run_model, gather_inputs
...
if __name__ == '__main__':
    ...
    run_model(data_path, model_path, exp_number, number_epochs, test_size, random_state, batch_size, confidence, GRUModel, loss_function, model_params, device, seq_dim)