...
test_size=0.315  #we predict on one year of future data (24 hours*366 days)
random_state=42
...
sales_column, validation_sales = train_test_split(before_sales_column, test_size=test_size, random_state=random_state)#shuffle=False),
