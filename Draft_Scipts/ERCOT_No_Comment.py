...
ohe_all_data = pd.get_dummies(df[common_delivery])
...
stat_model, stat_model_validation = train_test_split(before_split_train_manipulated, test_size=test_size, random_state=random_state)
...
if __name__ == '__main__':
    writer = SummaryWriter("log/exp22")
    global_step = 1
