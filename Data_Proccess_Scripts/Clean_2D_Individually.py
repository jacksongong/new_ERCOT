...
def concat_2D(list_load, csv_path, pickle_path):
    ...
    columns_to_rename_523 = list_load[0].columns[2:]
    ...
    columns_to_rename_565 = list_load[1].columns[2:]
    ...
    columns_to_rename_732 = list_load[2].columns[2:]
    ...
    columns_to_rename_737 = list_load[3].columns[2:]
    ...
    columns_to_rename_742 = list_load[4].columns[2:]
